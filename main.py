...
def insertintotable():
    ...
    def ARIMA_ALGO(df):
        ...
        def arima_model(train, test):
            ...
            for t in range(len(test)):
                model = SARIMAX(history, order=(6,1 ,0))
    ...
    def retrieving_tweets_polarity(symbol):
        ...
        tweets = tweepy.Cursor(user.search_30_day(label=None,query=None), q=symbol, tweet_mode='extended', lang='en',exclude_replies=True).items(ct.num_of_tweets)
    ...
    try:
        ...
        polarity,tw_list,tw_pol = retrieving_tweets_polarity(quote)
